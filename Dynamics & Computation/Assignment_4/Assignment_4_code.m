function [tHist,yHist] = RungeKutta4(f,t0,h,n,y0) 
  ...
  % Kutta 4 scheme with timestep h, initial time t0, and initial condition 
  % y0. The system of m ODEs are of the form y' = f(t,y), and are specified 
  % by a function handle for f
  %
  % The function outputs an (n+1)-by-1 vector tHist ("hist" for "history"),
  % containing the discrete times at which the solution is approximated, 
  % and the (n+1)-by-m matrix yHist, containing the approxmation of the 
  % solution at the given time steps
