...
public class Graph {
	...
	/**
	 * This constructor accepts an ArrayList<Vertex> and populates this.vertices. If
	 * multiple Vertex objects have the same label, then the last Vertex with the
	 * given label is used.
	 * 
	 * @param vertices
	...
	/**
	 * This method adds am edge between Vertices one and two of weight 1, if no Edge
	 * between these Vertices already exists in the Graph.
	 * 
	 * @param one
	...
	/**
	 * Accepts two vertices and a weight, and adds the edge ({one, two}, weight) iff
	 * no Edge relating one and two exists in the Graph.
	 * 
	 * @param one
	...
	/**
	 * This method adds a Vertex to the graph. If a Vertex with the same label as
	 * the parameter exists in the Graph, the existing Vertex is overwritten only if
	 * overwriteExisting is true. If the existing Vertex is overwritten, the Edges
	 * incident to it are all removed from the Graph.
	 *  
	 * @param vertex
